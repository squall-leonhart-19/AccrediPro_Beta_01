...
2-Step Pipeline: Anthropic (Claude) → WaveSpeed
...
def generate_all_levels(course_name: str, base_income: int, base_reviews: int,
    ...
    for i, level in enumerate(LEVEL_ORDER):
        ...
        print(f"🤖 [{i+1}/4] {level.upper()}: ${income:,}/mo | {reviews} reviews")
    
    print("-" * 50)
    print("⏳ Generating all 4 in parallel...")
    ...
    print("-" * 50)
    print(f"⏱️  Total: {elapsed:.1f}s | ✅ {success_count}/4 success")
...
def batch_generate(courses: list, output_dir: str, levels: list,
    ...
    print(f"\n🚀 AccrediPro AI Thumbnail Generator v6 (V3 CRO Template)")
    print(f"📐 16:9 | Resolution: {resolution}")
    print(f"📁 Output: {output_dir}")
    print(f"🎯 {len(courses)} courses × {len(levels)} levels = {total_jobs} images")
    print("-" * 60)
