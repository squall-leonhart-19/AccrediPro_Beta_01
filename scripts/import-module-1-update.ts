...
// Module 1 lesson definitions (8 lessons)
...
async function main() {
  // Path to the updated Module 1 files
  const modulePath = path.join(process.cwd(), "FM/FM-Update/Module_01");

  console.log("🚀 Starting Module 1 Import (Updated Content)...\n");
  ...
  console.log("\n✨ Module 1 content update complete!");
