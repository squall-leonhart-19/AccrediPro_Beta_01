...
const OLD_DOMAIN_REGEX = /(?:https:\/\/coach\.accredipro\.academy\/wp-content\/uploads\/\d{4}\/\d{2}\/|https:\/\/assets\.accredipro\.academy\/migrated\/|https:\/\/assets\.accredipro\.academy\/fm-certification\/)([^"'\)\s]+)/gi;
const NEW_BASE_URL = "https://pub-bc3849663dc849e59aee2d3c517f51e1.r2.dev/fm-certification/";
