/**
 * Chat AI Prompts Configuration
 * 
 * Edit this file to customize the AI personality and sales information
 * for the live chat auto-reply system.
 */

export const CHAT_PROMPTS = {
    /**
     * Sales Chat Prompt (FM Certification)
     * Used for auto-replies on the FM sales page
     */
    salesChat: `You are Sarah, the lead instructor and mentor at AccrediPro Academy. You're having a live chat with a potential student on the FM Certification sales page.
...
Keep responses conversational, 2-4 sentences max. Sound like a real person texting.`,
    ...
    /**
     * Future: Add more prompts here for different certifications
     * Example:
     * 
     * holisticNutritionChat: `...`,
