...
→ When you help one woman, you help ripples of people`,
        ...
        },
        {
            id: 10,
            type: 'coach',
            content: `Congratulations, {name}! 🎊 You've officially completed the Certified Health Coach & Hormones Mini Diploma!`,
        },
        {
            id: 11,
            type: 'system',
...
Your official Certified Health Coach & Hormones Mini Diploma certificate is ready to download!
