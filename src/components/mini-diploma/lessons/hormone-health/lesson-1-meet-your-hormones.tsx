    ...
    const messages: Message[] = [
        {
            id: 1,
            type: 'coach',
            content: `Hey {name}! 💕 I'm so excited you're here to learn about Hormone Health!`,
        },
        {
            id: 2,
            type: 'coach',
...
This is why stress wreaks havoc on your cycle!`,
        ...
        },
        {
            id: 10,
            type: 'coach',
            content: `💡 Quick tip: when a woman comes to you with hormonal issues, always ask about her stress levels first. Stress is often the root cause.`,
        },
        {
            id: 11,
            type: 'system',
...
→ Balance is restored through lifestyle, not just supplements`,
        ...
        },
        {
            id: 12,
            type: 'coach',
            content: `In our next lesson, we'll explore the menstrual cycle - and how each phase affects how you feel.`,
        },
        {
            id: 13,
            type: 'coach',
