...
// Brand Colors - Purple theme for Spiritual Healing
const BRAND = {
    primary: "#6b21a8",
    primaryDark: "#4c1d95",
    primaryLight: "#9333ea",
        ...
        <div className="min-h-screen" style={{ backgroundColor: BRAND.cream }}>
                ...
                <div className="relative max-w-6xl mx-auto px-4">
                    <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-8 lg:gap-12 items-start">
                        ...
                        <div className="text-white">
                            {/* Spiritual Healing Badge */}
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6" style={{ backgroundColor: `${BRAND.gold}20`, border: `1px solid ${BRAND.gold}40` }}>
                                <Leaf className="w-4 h-4" style={{ color: BRAND.gold }} />
                                <span className="text-sm font-medium" style={{ color: BRAND.gold }}>1-Hour Certification in Spiritual Healing</span>
                            </div>

                            <h1 className="text-3xl md:text-5xl lg:text-[3.5rem] font-black leading-[1.1] mb-6">
                                <span style={{ color: BRAND.goldLight }}>Turn Your Healing Gift</span><br />
                                <span className="text-white">Into a Thriving Practice</span><br />
                                <span className="text-white/80 text-2xl md:text-3xl lg:text-4xl">Help Others Heal. Earn $3K-$6K/Month.</span>
                            </h1>

                            <p className="text-lg md:text-xl text-white/80 mb-8 max-w-lg leading-relaxed">
                                Get <strong className="text-white">certified in 1 hour</strong>. Your spiritual gifts are meant to be shared.
                                Join 187 healers this week who turned their intuitive abilities into a meaningful, profitable practice.
                            </p>
                            ...
                            <div className="flex flex-wrap items-center gap-3 mb-8">
                                ...
                                <div className="min-w-0">
                                    <p className="text-white text-sm font-semibold">2,100+ spiritual healers certified</p>
                        ...
                        <div>
                            ...
                            <div className="space-y-4 text-gray-600 leading-relaxed">
                                ...
                                <p>
                                    ...
                                    that spiritual healing isn't just "woo-woo" — it's a legitimate practice with methods, ethics, and structure.
                                    Within months, I had paying clients. Within a year, I'd built a full practice.
                                </p>
                                <p>
                                    Now I train others who feel the same calling. <strong className="text-gray-900">2,100+ healers</strong> have
            ...
            <section className="py-16 md:py-20" style={{ backgroundColor: "#faf5eb" }}>
                <div className="max-w-5xl mx-auto px-4">
                    <div className="text-center mb-4">
                        <p className="font-bold text-sm uppercase tracking-wide mb-3" style={{ color: BRAND.primary }}>Join 2,100+ Healers Who Answered Their Calling</p>
                    ...
                    <div className="flex justify-center gap-6 mb-10">
                        <div className="text-center">
                            ...
                            <p className="text-xs text-gray-500">Certified Healers</p>
                        </div>
                        <div className="text-center">
                        ...
                        <div className="grid md:grid-cols-2">
                            ...
                            <div className="p-8" style={{ backgroundColor: BRAND.primaryDark }}>
                                ...
                                <h3 className="text-2xl md:text-3xl font-black text-white mb-4">
                                    Become a<br />
                                    <span style={{ color: BRAND.gold }}>Certified Spiritual Healer</span>
                                </h3>
                            ...
                            <div className="p-8 flex flex-col justify-center" style={{ backgroundColor: "#faf5eb" }}>
                                <div className="text-center">
                                    <p className="text-sm font-bold uppercase tracking-wide mb-2" style={{ color: BRAND.primary }}>Average Healer Income</p>
                ...
                <div className="max-w-5xl mx-auto px-4">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">
                            Your Intuitive Gifts Are<br />
                            <span style={{ color: BRAND.primary }}>Your Unfair Advantage</span>
                        </h2>
                        <p className="text-gray-600 max-w-2xl mx-auto">
                            You already sense energy. You feel what others feel. You know things without being told.
                            You just need the <strong>framework and ethics</strong> to turn that into a practice.
                        </p>
                    </div>

                    <div className="grid md:grid-cols-3 gap-6">
                        {[
                            { icon: Leaf, title: "Natural Sensitivity", desc: "You already pick up on energy, emotions, and subtle shifts. That's the foundation of all healing work." },
                            { icon: BookOpen, title: "Desire to Help", desc: "You feel called to serve others. That calling is the engine that drives a successful practice." },
                            { icon: Heart, title: "Empathic Connection", desc: "You naturally create safe space for others. That's what clients pay for — feeling truly seen and held." }
                        ].map((item, i) => (
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative transform hover:scale-[1.02] transition-transform">
                                <CertificatePreview
                                    diplomaTitle="Spiritual Healing"
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 mb-6 leading-relaxed">
                                ...
                                Add it to LinkedIn today. Show the world you're a trained spiritual healing practitioner.
                            </p>
            ...
            <section className="py-16 md:py-20 text-white" style={{ backgroundColor: BRAND.primaryDark }}>
                <div className="max-w-5xl mx-auto px-4">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                        {[
                            { num: 1, title: "Foundations of Spiritual Healing", desc: "The principles that guide all healing work" },
            ...
            <section className="py-16 md:py-20 bg-white">
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <div className="bg-gray-50 rounded-2xl border border-gray-200 overflow-hidden">
                        {[
                            { item: "9-Lesson Spiritual Healing Mini-Diploma", value: "$97" },
                            ...
                            { item: "Private Community Access (2,100+ healers)", value: "$47" }
                        ].map((row, i) => (
            ...
            <section className="py-16 md:py-20" style={{ backgroundColor: BRAND.cream }}>
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <div className="space-y-3">
                        {[
                            { q: "Is spiritual healing legitimate? Can I really make money doing this?", a: "Absolutely. The wellness industry is worth over $4 trillion globally, and spiritual healing is one of the fastest-growing segments. Our graduates earn $3K-$6K/month part-time by helping clients with stress, emotional blocks, and life transitions. People are craving deeper healing — and they're willing to pay for it." },
                            { q: "Do I need to have special gifts or abilities?", a: "If you feel called to this work, you have what it takes. Spiritual healing isn't about having magical powers — it's about creating safe space, working with energy, and guiding transformation. The techniques can be learned; the calling comes from within." },
                            ...
                            { q: "What's the catch? Why is it free?", a: "Simple: we give you a genuinely valuable free certification so you can experience spiritual healing training. If you love it (most do), you'll want to continue with our full Board Certification program. If not, you still walk away with a real credential and practical knowledge. Win-win." },
                            { q: "Is this certification recognized?", a: "ASI (AccrediPro Standards Institute) is our credentialing body for wellness practitioners. While spiritual healing isn't regulated like medicine (which is actually a good thing — it gives you freedom to practice), our certification demonstrates you've been trained in ethical, effective methods. 2,100+ practitioners carry our credential." },
                            { q: "What if I have questions during the course?", a: "You'll have access to our private community of 2,100+ healers, plus you can message me directly. We're here to support your journey every step of the way." }
                        ].map((faq, i) => (
            ...
            <section className="py-16 md:py-20 text-white text-center" style={{ backgroundColor: BRAND.primaryDark }}>
                <div className="max-w-3xl mx-auto px-4">
                    <h2 className="text-3xl md:text-4xl font-black mb-6">
                        ...
                        <span style={{ color: BRAND.gold }}>A Certified Spiritual Healer.</span>
                    </h2>
                    <p className="text-white/70 text-lg mb-8 max-w-xl mx-auto">
                        187 healers started this week. 91% finished the same day.
