...
const TESTIMONIALS = [
    {
        name: "Jennifer M.",
        role: "Former HR Manager → Certified Holistic Nutrition Coach",
    ...
    {
        name: "Rachel T.",
        role: "Yoga Instructor + Holistic Nutrition Specialist",
...
const LEARNING_OUTCOMES = [
    "Identify nutritional deficiencies driving chronic health issues",
    "Understand the food-inflammation connection most doctors miss",
    "Design personalized nutrition protocols for clients",
    "Help clients break free from yo-yo dieting forever",
    "Position yourself as a specialist in the $4.5 trillion wellness industry",
];

// What you get - value table
const WHAT_YOU_GET = [
    { item: "3 Expert-Led Modules", value: "Deep-dive into holistic nutrition" },
...
export default function WomensHealthMiniDiplomaPage() {
    ...
    return (
        <div className="min-h-screen bg-white">
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="text-white">
                            ...
                            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight">
                                ...
                                <span className="block text-gold-400 mt-1">Holistic Nutrition Specialist</span>
                            </h1>
                ...
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <div className="bg-white rounded-xl p-5 border border-burgundy-200 max-w-2xl mx-auto">
                        <p className="text-gray-700 italic mb-3">
                            &ldquo;I finished the mini-diploma on my lunch break. Now I&apos;m helping clients transform their relationship with food — and their health.&rdquo;
                        </p>
                        <p className="text-sm text-gray-500">— Michelle R., Former Teacher, Now Holistic Nutrition Coach</p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-10 bg-gradient-to-r from-burgundy-600 to-burgundy-700">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-burgundy-100 mb-5">
                        We&apos;re currently accepting new students into the Holistic Nutrition track.<br />
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div className="text-center md:text-left">
                                ...
                                <p className="text-gray-600 mb-4 text-sm">
                                    Sarah has helped over 5,000 practitioners master nutrition coaching — and build thriving practices.
                                    After transforming her own health through food, she became obsessed with teaching others.
                                    Now she trains the next generation of Holistic Nutrition specialists.
                                </p>
            ...
            <section className="py-14 bg-gradient-to-br from-burgundy-700 via-burgundy-800 to-burgundy-900">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-burgundy-200 text-lg mb-6 max-w-2xl mx-auto">
                        In 60 minutes, you&apos;ll understand nutrition science better than most conventionally trained dietitians.
                    </p>
            ...
            {/* Live Chat Widget */}
            <FloatingChatWidget page="holistic-nutrition-mini-diploma" />
        </div>
    );
}
