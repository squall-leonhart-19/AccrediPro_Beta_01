...
import {
    ...
    DollarSign, Heart, Sparkles, X, Stethoscope, TrendingUp
} from "lucide-react";
...
import { EnhancedQualificationForm, EnhancedQualificationData } from "@/components/lead-portal/enhanced-qualification-form";
import { TrustpilotBanner } from "@/components/ui/trustpilot-banner";
...
function HealthcareWorkersMiniDiplomaContent() {
    ...
    // Real-time enrollment stats (audit recommendation: replace fake scarcity)
    ...
    useEffect(() => {
        trackViewContent(
            "Functional Medicine Mini Diploma V2 - Healthcare Workers",
            "fm-mini-diploma-healthcare-v2",
            PIXEL_CONFIG.FUNCTIONAL_MEDICINE
        );
    }, [trackViewContent]);

    const handleSubmit = async (formData: EnhancedQualificationData) => {
        setIsVerifying(true);
        ...
        try {
            ...
            const response = await fetch("/api/mini-diploma/optin", {
                ...
                body: JSON.stringify({
                    ...
                    healthcareBackground: formData.healthcareBackground, // NEW: Healthcare filter
                    hasCommitted: formData.hasCommitted, // NEW: Commitment checkbox
                    course: "fm-healthcare-v2",
                    segment: "healthcare-workers-v2",
                }),
            });
    ...
    return (
        <div className="min-h-screen" style={{ backgroundColor: BRAND.cream }}>
            ...
            {/* TRUSTPILOT BANNER - Real Social Proof (Audit Optimization) */}
            <TrustpilotBanner
                rating={4.8}
                reviewCount={2847}
                variant="compact"
            ...
            {/* REAL-TIME STATS BAR (replaces fake countdown) */}
            <div style={{ background: BRAND.goldMetallic }} className="py-2.5 px-4 text-center">
                <p className="text-sm font-bold flex items-center justify-center gap-3 flex-wrap" style={{ color: BRAND.burgundyDark }}>
                    <span className="flex items-center gap-1">
                        <TrendingUp className="w-4 h-4" />
                        {liveStats.enrolledToday} enrolled today
                    </span>
                    <span className="hidden sm:inline">•</span>
                    <span className="flex items-center gap-1">
                        <Users className="w-4 h-4" />
                        {liveStats.inModule3} currently in Module 3
                    </span>
                    <span className="hidden sm:inline">•</span>
                    <span className="text-xs px-2 py-0.5 rounded-full bg-green-600 text-white">
                        89% complete same day
                    </span>
                </p>
            </div>
                    ...
                    <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-8 lg:gap-12 items-start">
                        ...
                        <div className="text-white">
                            ...
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6" style={{ backgroundColor: `${BRAND.gold}20`, border: `1px solid ${BRAND.gold}40` }}>
                                ...
                                <span className="text-sm font-medium" style={{ color: BRAND.gold }}>60-Minute Foundation • For Healthcare Professionals</span>
                            </div>
                            ...
                            <p className="text-lg md:text-xl text-white/80 mb-8 max-w-lg leading-relaxed">
                                Complete your <strong className="text-white">Foundation Certificate in 60 minutes</strong>. Your clinical skills are worth more than hospital wages.
                                Join {liveStats.enrolledThisWeek}+ nurses this week turning their healthcare background into a flexible coaching career.
                            </p>
                            ...
                            <div className="flex flex-wrap gap-4 md:gap-6 mb-8">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        <p className="font-bold text-white">60 min</p>
                                        <p className="text-xs text-white/60">Foundation course</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-2">
                                    <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: `${BRAND.gold}20` }}>
            ...
            <section className="py-16 md:py-20 text-white text-center" style={{ backgroundColor: BRAND.burgundyDark }}>
                <div className="max-w-3xl mx-auto px-4">
                    <h2 className="text-3xl md:text-4xl font-black mb-6">
                        60 Minutes From Now, You Could Be<br />
