...
const Confetti = () => {
    ...
    useEffect(() => {
        // Added more green for Holistic Nutrition vibe
        const colors = ['#722f37', '#d4af37', '#8b9a64', '#4a7c59', '#fdfaf5'];
...
export default function HNCertificationThankYouPage() {
            ...
            <div className="max-w-4xl mx-auto px-4 py-12 sm:py-16">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                        Your payment was successful. You're now enrolled in the <span className="font-semibold text-burgundy-700">Certified Holistic Nutrition Coach™</span> program.
                    </p>
                    <div className="mt-6 flex items-center justify-center gap-4 text-sm flex-wrap">
                        <div className="flex items-center gap-2 bg-burgundy-50 px-4 py-2 rounded-full">
                            ...
                            <span className="text-burgundy-700 font-medium">16 Modules</span>
                        </div>
                        <div className="flex items-center gap-2 bg-gold-50 px-4 py-2 rounded-full">
                            <GraduationCap className="h-4 w-4 text-gold-600" />
                            <span className="text-gold-700 font-medium">15 Certificates</span>
                        </div>
                    ...
                    <div className="p-6 sm:p-8 space-y-8">
                        ...
                        <div className="flex gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-slate-600 mt-1">
                                    Within the next <strong>24 hours</strong>, I'll personally reach out to welcome you, answer any questions, and make sure you're set up for success in your nutrition studies.
                                </p>
                        ...
                        <div className="flex gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-slate-600 mt-1">
                                    Log in and begin with Module 0 to get oriented. It's designed to set you up for success and show you exactly how to navigate your V.I.T.A.L. method training.
                                </p>
                                <div className="mt-3 grid grid-cols-2 sm:grid-cols-4 gap-3">
                                    <div className="flex flex-col items-center gap-1 text-center p-3 bg-slate-50 rounded-lg">
                                        ...
                                        <span className="text-xs text-slate-600">16 Modules</span>
                                    </div>
                                    <div className="flex flex-col items-center gap-1 text-center p-3 bg-slate-50 rounded-lg">
                                        <Clock className="h-5 w-5 text-burgundy-500" />
                                        <span className="text-xs text-slate-600">60+ Hours</span>
                                    </div>
                                    <div className="flex flex-col items-center gap-1 text-center p-3 bg-slate-50 rounded-lg">
                                        <GraduationCap className="h-5 w-5 text-burgundy-500" />
                                        <span className="text-xs text-slate-600">15 Certificates</span>
                                    </div>
                                    <div className="flex flex-col items-center gap-1 text-center p-3 bg-slate-50 rounded-lg">
                        ...
                        <div className="flex gap-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-slate-600 mt-1">
                                    Inside the portal, you'll find access to our <strong>2,000+ member community</strong> of practitioners. Introduce yourself, connect with others, and get support anytime.
                                </p>
                            </div>
                        </div>
                ...
                <div className="bg-gradient-to-r from-burgundy-600 to-burgundy-700 rounded-2xl p-6 sm:p-8 text-center text-white mb-8 shadow-xl">
                    <h3 className="text-2xl font-bold mb-2">Ready to Transform Lives Through Nutrition?</h3>
                    <p className="text-burgundy-100 mb-6 max-w-lg mx-auto">
                        Your complete Holistic Nutrition Certification awaits. Log in now to begin Module 0.
                    </p>
                ...
                <div className="bg-white rounded-2xl p-6 border border-slate-100 shadow-sm mb-8">
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <p className="font-medium text-slate-800">Complete Nutrition Certification</p>
                                <p className="text-sm text-slate-500">16 comprehensive modules</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            <CheckCircle2 className="h-5 w-5 text-olive-500 shrink-0 mt-0.5" />
                            <div>
                                <p className="font-medium text-slate-800">15 Specialty Certificates</p>
                ...
                <div className="bg-cream-50 rounded-2xl p-6 border border-cream-200">
                    ...
                    <div className="flex gap-4 sm:gap-6">
                        ...
                        <div className="text-slate-600 italic">
                            <p className="mb-2">
                                "I am SO excited you're here. This Holistic Nutrition certification is going to change your life, and the lives of those you help.
                            </p>
                            <p className="mb-2">
                                You're not just getting a certification—you're joining a <strong className="text-slate-800 not-italic">movement</strong> of practitioners who are healing the world through food.
                            </p>
                            <p className="mb-2">
