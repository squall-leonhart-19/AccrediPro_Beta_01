                    ...
                    <div className="grid lg:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="text-white">
                            ...
                            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight">
                                ...
                                <span className="block text-gold-400 mt-1">Functional Medicine Specialist</span>
                            </h1>
                ...
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <div className="bg-white rounded-xl p-5 border border-burgundy-200 max-w-2xl mx-auto">
                        <p className="text-gray-700 italic mb-3">
                            &ldquo;I finished the mini-diploma on my lunch break. Now I&apos;m 3 months into my certification and already helping clients find root causes their doctors missed.&rdquo;
                        </p>
                        <p className="text-sm text-gray-500">— Michelle R., Former Nurse, Now Functional Medicine Practitioner</p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-10 bg-gradient-to-r from-burgundy-600 to-burgundy-700">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-burgundy-100 mb-5">
                        We&apos;re currently accepting new students into the Functional Medicine track.<br />
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div className="text-center md:text-left">
                                ...
                                <p className="text-gray-600 mb-4 text-sm">
                                    Sarah has helped over 5,000 practitioners transform their practice — and their careers.
                                    After years of frustration with conventional medicine&apos;s symptom-chasing approach, she became obsessed with root-cause protocols.
                                    Now she trains the next generation of Functional Medicine specialists.
                                </p>
            ...
            <section className="py-14 bg-gradient-to-br from-burgundy-700 via-burgundy-800 to-burgundy-900">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-burgundy-200 text-lg mb-6 max-w-2xl mx-auto">
                        In 60 minutes, you&apos;ll understand root-cause medicine better than most conventionally trained doctors.
                    </p>
