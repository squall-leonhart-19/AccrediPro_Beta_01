...
const TESTIMONIALS = [
    {
        name: "Jennifer M.",
        role: "Former HR Manager → Certified Nurse Life Coach Coach",
    ...
    {
        name: "Rachel T.",
        role: "Yoga Instructor + Nurse Life Coach Specialist",
...
const LEARNING_OUTCOMES = [
    "Leverage your nursing expertise into a coaching career",
    "Understand the transition from bedside to business",
    "Build a coaching practice that values your clinical skills",
    "Help nurses prevent burnout and find fulfillment",
    "Position yourself as a specialist in the nurse coaching market",
];

// What you get - value table
const WHAT_YOU_GET = [
    { item: "3 Expert-Led Modules", value: "Deep-dive into nurse life coaching" },
    ...
    { item: "Career Roadmap", value: "See exactly how to build your coaching business" },
];
...
export default function WomensHealthMiniDiplomaPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (result?.error) {
                ...
                window.location.href = "/nurse-coach-mini-diploma/thank-you";
            } else {
                window.location.href = "/nurse-coach-mini-diploma/thank-you";
            }
    ...
    return (
        <div className="min-h-screen bg-white">
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="text-white">
                            ...
                            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight">
                                ...
                                <span className="block text-gold-400 mt-1">Nurse Life Coach</span>
                            </h1>
                ...
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <div className="bg-white rounded-xl p-5 border border-burgundy-200 max-w-2xl mx-auto">
                        <p className="text-gray-700 italic mb-3">
                            &ldquo;I finished the mini-diploma on my lunch break. After 15 years at the bedside, I finally have a path out that uses my skills.&rdquo;
                        </p>
                        <p className="text-sm text-gray-500">— Michelle R., Former ICU Nurse, Now Nurse Life Coach</p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-10 bg-gradient-to-r from-burgundy-600 to-burgundy-700">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-burgundy-100 mb-5">
                        We&apos;re currently accepting new students into the Nurse Life Coach track.<br />
                        Spots fill fast — over 200 nurses joined this week alone.
                    </p>
                    <Button
                        onClick={scrollToForm}
                        size="lg"
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div className="text-center md:text-left">
                                ...
                                <p className="text-gray-600 mb-4 text-sm">
                                    Sarah has helped over 5,000 nurses transition from burnout to thriving coaching careers.
                                    After 12 years at the bedside, she built her own escape route.
                                    Now she trains the next generation of Nurse Life Coaches.
                                </p>
            ...
            <section className="py-14 bg-gradient-to-br from-burgundy-700 via-burgundy-800 to-burgundy-900">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-burgundy-200 text-lg mb-6 max-w-2xl mx-auto">
                        In 60 minutes, you&apos;ll see how your nursing skills translate into a fulfilling coaching career.
                    </p>
            ...
            {/* Live Chat Widget */}
            <FloatingChatWidget page="nurse-coach-mini-diploma" />
        </div>
    );
}
