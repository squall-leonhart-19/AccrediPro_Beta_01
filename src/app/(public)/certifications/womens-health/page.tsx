        ...
        schemas={[
          {
            type: "Course",
            data: {
              name: "Certified Women's Health Specialist",
              description: "Board Certified Women's Health Specialist credential covering hormones, fertility, and menopause. Accredited by ASI.",
              duration: "P12W"
            }
          },
          {
            type: "Product",
            data: {
              name: "Women's Health Certification (Practitioner Kit)",
              description: "Complete Women's Health Specialist board certification including physical welcome kit.",
              url: "https://learn.accredipro.academy/certifications/womens-health",
              price: "1997.00"
            }
          },
          {
            ...
            data: {
              questions: [
                {
                  question: "Is this Women's Health certification accredited?",
                  answer: "Yes, it is board certified by the AccrediPro Standards Institute (ASI) and recognized globally."
                },
                {
                  question: "How long does it take to complete?",
                  answer: "The program is self-paced but designed to be completed in 12 weeks with 3-5 hours of study per week."
                },
                {
                  question: "Do I get a physical certificate?",
                  answer: "Yes, you receive both a digital verified badge and a physical gold-embossed certificate in your welcome kit."
                }
              ]
            }
          }
