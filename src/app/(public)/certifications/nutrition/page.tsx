...
export const metadata = {
  title: "Nutrition Certification | ASI",
  description: "Become a certified Holistic Nutrition Coach. Master evidence-based nutrition, therapeutic diets, and behavior change. Start free.",
};
...
export default function NutritionPage() {
  const certificationLevels = [
    {
      ...
      duration: "4-6 weeks",
      price: "FREE",
      description: "Introduction to holistic nutrition and food as medicine.",
      outcomes: ["Nutrition foundations", "Macros & micros", "Food as medicine basics"],
      cta: "Start Free",
    ...
    },
    {
      ...
      duration: "8-12 weeks",
      price: "$1,997",
      description: "Comprehensive training in therapeutic nutrition and coaching.",
      outcomes: ["Therapeutic diets", "Client protocols", "Behavior change"],
      cta: "Enroll Now",
      href: "/apply",
      highlight: false,
    },
  ...
  const specializations = [
    { title: "Therapeutic Diets", description: "Elimination, AIP, Mediterranean, and more", icon: "🥗" },
    { title: "Blood Sugar Balance", description: "Metabolic health and insulin sensitivity", icon: "📊" },
    { title: "Anti-Inflammatory Nutrition", description: "Reducing inflammation through food", icon: "🔥" },
    { title: "Food Sensitivities", description: "Identification and elimination protocols", icon: "🔍" },
    { title: "Plant-Based Nutrition", description: "Whole food plant-based protocols", icon: "🥬" },
    { title: "Sports & Performance", description: "Nutrition for active clients", icon: "🏃" },
  ];

  const careerOutcomes = [
    { value: "$65K-$130K", label: "Avg Annual Income" },
    { value: "Growing", label: "High Demand Field" },
    { value: "18,000+", label: "Certified Practitioners" },
  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                  <div className="bg-white rounded-xl shadow-xl border border-gray-100 py-2 min-w-[250px]">
                    ...
                    <Link href="/certifications/nutrition" className="block px-4 py-2 text-sm hover:bg-gray-50 font-semibold" style={{ color: BRAND.gold }}>Nutrition</Link>
      ...
      {/* Hero Section */}
      <section className="relative py-20 md:py-28 text-white overflow-hidden" style={{ background: "linear-gradient(135deg, #15803d 0%, #22c55e 50%, #4ade80 100%)" }}>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 bg-white/20">
                ...
                <span className="text-sm font-medium text-white">Nutrition & Coaching</span>
              </div>

              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                Become a Certified
                <span className="block text-green-200">Holistic Nutrition Coach</span>
              </h1>

              <p className="text-xl mb-6 text-green-100">
                Master evidence-based nutrition, therapeutic diets, and behavior change coaching.
              </p>

              <div className="flex flex-wrap gap-4 mb-8">
                <div className="flex items-center gap-2 text-sm">
                  <CheckCircle className="w-5 h-5 text-green-200" />
                  <span>Evidence-based training</span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <CheckCircle className="w-5 h-5 text-green-200" />
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/womens-health-mini-diploma">
                  <Button size="lg" className="font-bold text-lg px-8 py-6 h-auto bg-white text-green-600 hover:bg-green-50">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {certificationLevels.map((cert, i) => (
              <div key={i} className={`bg-white rounded-2xl p-8 shadow-lg border-2 ${cert.highlight ? 'border-green-500 relative' : 'border-gray-100'}`}>
                {cert.highlight && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full text-sm font-bold bg-green-500 text-white">Start Here</div>
                )}
                ...
                <div className="flex items-baseline gap-2 mb-4">
                  <span className="text-3xl font-bold" style={{ color: cert.highlight ? '#15803d' : BRAND.burgundy }}>{cert.price}</span>
                ...
                <ul className="space-y-2 mb-6">
                  {cert.outcomes.map((outcome, j) => (
                    <li key={j} className="flex items-start gap-2 text-sm">
                      <CheckCircle className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: cert.highlight ? '#15803d' : BRAND.gold }} />
                      <span className="text-gray-700">{outcome}</span>
                    </li>
                  ))}
                </ul>
                <Link href={cert.href}>
                  <Button className={`w-full font-bold ${cert.highlight ? 'bg-green-500 hover:bg-green-600 text-white' : ''}`} style={!cert.highlight ? { backgroundColor: BRAND.burgundy, color: 'white' } : {}}>
                    {cert.cta}
      ...
      {/* CTA */}
      <section className="py-20" style={{ background: "linear-gradient(135deg, #15803d 0%, #22c55e 100%)" }}>
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Start Your Nutrition Journey Today</h2>
          <p className="text-xl mb-8 text-green-200">Begin with our free Mini-Diploma. No credit card required.</p>
          <Link href="/womens-health-mini-diploma">
            <Button size="lg" className="font-bold text-lg px-8 py-6 h-auto bg-white text-green-600 hover:bg-green-50">
              Start Free Today
              <ArrowRight className="w-5 h-5 ml-2" />
