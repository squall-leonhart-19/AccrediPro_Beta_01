...
export const metadata = {
  title: "Gut Health Certification | ASI",
  description: "Become a certified Gut Health Specialist. Master the microbiome, 5R protocol, and digestive wellness. Start free with our Mini-Diploma.",
};
...
export default function GutHealthPage() {
  const certificationLevels = [
    {
      ...
      duration: "4-6 weeks",
      price: "FREE",
      description: "Introduction to gut health and the microbiome foundations.",
      outcomes: ["Understand the microbiome", "Digestive basics", "Foundation knowledge"],
      cta: "Start Free",
    ...
    {
      level: "Level 2",
      name: "Gut Health Coach",
      duration: "8-12 weeks",
      price: "$1,997",
      description: "Comprehensive training in gut restoration and digestive wellness.",
      outcomes: ["5R Protocol mastery", "SIBO & IBS protocols", "Microbiome optimization"],
      cta: "Enroll Now",
      href: "/apply",
      highlight: false,
    },
  ...
  const specializations = [
    { title: "Microbiome Optimization", description: "Cultivating a healthy inner ecosystem", icon: "🦠" },
    { title: "The 5R Protocol", description: "Remove, Replace, Reinoculate, Repair, Rebalance", icon: "🔄" },
    { title: "SIBO & IBS", description: "Root-cause approaches to digestive disorders", icon: "🔬" },
    { title: "Leaky Gut Repair", description: "Restoring intestinal permeability", icon: "🛡️" },
    { title: "Gut-Brain Connection", description: "The enteric nervous system", icon: "🧠" },
    { title: "Food Sensitivities", description: "Identification and elimination protocols", icon: "🍎" },
  ];

  const careerOutcomes = [
    { value: "$70K-$140K", label: "Avg Annual Income" },
    { value: "Growing", label: "High Demand Specialty" },
    { value: "12,000+", label: "Certified Practitioners" },
  ...
  return (
    <>
        ...
        schemas={[
          {
            type: "Course",
            data: {
              name: "Certified Gut Health Specialist",
              description: "Board Certified Gut Health Specialist credential covering microbiome, SIBO, and digestive wellness. Accredited by ASI.",
              duration: "P12W"
            }
          },
          {
            type: "Product",
            data: {
              name: "Gut Health Certification (Practitioner Kit)",
              description: "Complete Gut Health Specialist board certification including physical welcome kit.",
              url: "https://learn.accredipro.academy/certifications/gut-health",
              price: "1997.00"
            }
          },
          {
            ...
            data: {
              questions: [
                {
                  question: "What does the Gut Health certification cover?",
                  answer: "It covers the microbiome, the 5R Protocol, SIBO, leaky gut, and the gut-brain connection."
                },
                {
                  question: "Is it accredited?",
                  answer: "Yes, it is board certified by the AccrediPro Standards Institute (ASI)."
                }
              ]
            }
          }
      ...
      <div className="min-h-screen bg-white">
                ...
                <div className="relative group">
                  ...
                  <div className="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                    <div className="bg-white rounded-xl shadow-xl border border-gray-100 py-2 min-w-[250px]">
                      ...
                      <Link href="/certifications/gut-health" className="block px-4 py-2 text-sm hover:bg-gray-50 font-semibold" style={{ color: BRAND.gold }}>Gut Health</Link>
        ...
        {/* Hero Section */}
        <section className="relative py-20 md:py-28 text-white overflow-hidden" style={{ background: "linear-gradient(135deg, #059669 0%, #10b981 50%, #34d399 100%)" }}>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 bg-white/20">
                  ...
                  <span className="text-sm font-medium text-white">Gut Health</span>
                </div>

                <h1 className="text-4xl md:text-5xl font-bold mb-4">
                  Become a Certified
                  <span className="block text-emerald-200">Gut Health Specialist</span>
                </h1>

                <p className="text-xl mb-6 text-emerald-100">
                  Master the microbiome, 5R protocol, and digestive wellness. Help clients heal from the inside out.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/womens-health-mini-diploma">
                    <Button size="lg" className="font-bold text-lg px-8 py-6 h-auto bg-white text-emerald-600 hover:bg-emerald-50">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">Comprehensive training across all aspects of gut health</p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {certificationLevels.map((cert, i) => (
                <div key={i} className={`bg-white rounded-2xl p-8 shadow-lg border-2 ${cert.highlight ? 'border-emerald-500 relative' : 'border-gray-100'}`}>
                  {cert.highlight && (
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full text-sm font-bold bg-emerald-500 text-white">Start Here</div>
                  )}
                  ...
                  <div className="flex items-baseline gap-2 mb-4">
                    <span className="text-3xl font-bold" style={{ color: cert.highlight ? '#059669' : BRAND.burgundy }}>{cert.price}</span>
                  ...
                  <ul className="space-y-2 mb-6">
                    {cert.outcomes.map((outcome, j) => (
                      <li key={j} className="flex items-start gap-2 text-sm">
                        <CheckCircle className="w-4 h-4 flex-shrink-0 mt-0.5" style={{ color: cert.highlight ? '#059669' : BRAND.gold }} />
                        <span className="text-gray-700">{outcome}</span>
                      </li>
                    ))}
                  </ul>
                  <Link href={cert.href}>
                    <Button className={`w-full font-bold ${cert.highlight ? 'bg-emerald-500 hover:bg-emerald-600 text-white' : ''}`} style={!cert.highlight ? { backgroundColor: BRAND.burgundy, color: 'white' } : {}}>
                      {cert.cta}
        ...
        {/* CTA */}
        <section className="py-20" style={{ background: "linear-gradient(135deg, #059669 0%, #10b981 100%)" }}>
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Start Your Gut Health Journey Today</h2>
            <p className="text-xl mb-8 text-emerald-200">Begin with our free Mini-Diploma. No credit card required.</p>
            <Link href="/womens-health-mini-diploma">
              <Button size="lg" className="font-bold text-lg px-8 py-6 h-auto bg-white text-emerald-600 hover:bg-emerald-50">
                Start Free Today
                <ArrowRight className="w-5 h-5 ml-2" />
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid md:grid-cols-4 gap-8 mb-12">
              <div className="md:col-span-2">
                ...
                <p className="mb-6 max-w-sm" style={{ color: "#f5e6e8" }}>The global authority in functional medicine and health certification.</p>
              </div>
              <div>
