...
const TESTIMONIALS = [
    {
        name: "Jennifer M.",
        role: "Former HR Manager → Certified Certified Health Coach Coach",
    ...
    {
        name: "Rachel T.",
        role: "Yoga Instructor + Certified Health Coach Specialist",
...
const LEARNING_OUTCOMES = [
    "Understand the foundations of behavior change coaching",
    "Learn to guide clients through sustainable lifestyle transformations",
    "Recognize common health patterns and how to address them",
    "Build client accountability systems that actually work",
    "Position yourself as a specialist in the $4.5 trillion wellness industry",
];

// What you get - value table
const WHAT_YOU_GET = [
    { item: "3 Expert-Led Modules", value: "Deep-dive into health coaching fundamentals" },
...
export default function WomensHealthMiniDiplomaPage() {
    ...
    return (
        <div className="min-h-screen bg-white">
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="text-white">
                            ...
                            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight">
                                ...
                                <span className="block text-gold-400 mt-1">Health Coach</span>
                            </h1>
                ...
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <div className="bg-white rounded-xl p-5 border border-burgundy-200 max-w-2xl mx-auto">
                        <p className="text-gray-700 italic mb-3">
                            &ldquo;I finished the mini-diploma on my lunch break. Now I help clients make real, lasting changes — not just temporary fixes.&rdquo;
                        </p>
                        <p className="text-sm text-gray-500">— Michelle R., Former Corporate Manager, Now Certified Health Coach</p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-10 bg-gradient-to-r from-burgundy-600 to-burgundy-700">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-burgundy-100 mb-5">
                        We&apos;re currently accepting new students into the Health Coach track.<br />
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div className="text-center md:text-left">
                                ...
                                <p className="text-gray-600 mb-4 text-sm">
                                    Sarah has helped over 5,000 people become certified health coaches — and build thriving practices.
                                    After transforming her own health, she became passionate about teaching others to do the same.
                                    Now she trains the next generation of Health Coaches.
                                </p>
            ...
            <section className="py-14 bg-gradient-to-br from-burgundy-700 via-burgundy-800 to-burgundy-900">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-burgundy-200 text-lg mb-6 max-w-2xl mx-auto">
                        In 60 minutes, you&apos;ll understand health coaching fundamentals better than most wellness professionals.
                    </p>
            ...
            {/* Live Chat Widget */}
            <FloatingChatWidget page="health-coach-mini-diploma" />
        </div>
    );
}
