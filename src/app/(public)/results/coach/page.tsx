        ...
        <Section>
          <div className="px-4 sm:px-6 py-3" style={{ background: timeline === "this-week" ? B.burgundy : B.goldMetallic }}>
            <span className="text-xs sm:text-sm font-bold" style={{ color: timeline === "this-week" ? "white" : B.burgundyDark }}>
              <AlertTriangle className="w-3.5 h-3.5 sm:w-4 sm:h-4 inline mr-1.5 -mt-0.5" /> {timeline === "this-week" ? "URGENT — Your Cohort Starts This Week" : "Limited Availability — Coach Upgrade Track Cohort"}
            </span>
          </div>
          <SectionInner className="text-center space-y-5 sm:space-y-6">
            ...
            <p className="text-sm sm:text-base text-gray-600 max-w-lg mx-auto">
              {dreamLife === "leave-job" && `You said you want to leave your 9-to-5. This is the fastest path. ${urgencySpots} spots left in the Coach Upgrade Track.`}
