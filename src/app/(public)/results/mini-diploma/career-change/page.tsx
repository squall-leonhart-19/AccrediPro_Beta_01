...
// ─── Main ──────────────────────────────────────────────────────────
function MiniDiplomaCareerChangeResultsInner() {
  ...
  const persona = sp.get("persona") || "other-passionate";
        ...
        <Section>
          ...
          <SectionInner className="text-center space-y-5 sm:space-y-6">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 sm:px-4 py-1.5 rounded-full text-[10px] sm:text-xs font-bold uppercase tracking-widest" style={{ backgroundColor: `${B.burgundy}10`, color: B.burgundy }}>
              <Award className="w-3 h-3 sm:w-3.5 sm:h-3.5" /> For Passionate Career Changers
            </div>
            ...
            <p className="text-sm sm:text-base text-gray-600 max-w-xl mx-auto leading-relaxed">
              The exact starting point our highest-earning passionate practitioners used before going full-time. Level 0 of your functional medicine journey begins here.
            </p>
        ...
        <Section>
          <SectionInner className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-center" style={{ color: B.burgundyDark }}>
              Career Changers Who Took the Leap
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-[10px] sm:text-[11px] text-gray-400">Former Teacher, Now FM Practitioner</p>
                </div>
                <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
                  {firstName}, as a career changer myself, I know what you&apos;re going through. The exhaustion. The frustration. The feeling that there must be something more.
                </p>
...
export default function MiniDiplomaCareerChangeResultsPage() {
  return (
    <Suspense fallback={
      ...
      <MiniDiplomaCareerChangeResultsInner />
    </Suspense>
  );
}
