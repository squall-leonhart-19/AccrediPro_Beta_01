...
// ─── Main ──────────────────────────────────────────────────────────
function MiniDiplomaCorporateResultsInner() {
  ...
  const persona = sp.get("persona") || "corporate";
        ...
        <Section>
          ...
          <SectionInner className="text-center space-y-5 sm:space-y-6">
            ...
            <p className="text-sm sm:text-base text-gray-600 max-w-xl mx-auto leading-relaxed">
              The exact starting point our highest-earning career changers used before going full-time. Level 0 of your functional medicine journey begins here.
            </p>
        ...
        <Section>
          <SectionInner className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-center" style={{ color: B.burgundyDark }}>
              Corporate Professionals Who Made the Leap
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-[10px] sm:text-[11px] text-gray-400">Former Corporate, Now FM Practitioner</p>
                </div>
...
export default function MiniDiplomaCorporateResultsPage() {
  return (
    <Suspense fallback={
      ...
      <MiniDiplomaCorporateResultsInner />
    </Suspense>
  );
}
