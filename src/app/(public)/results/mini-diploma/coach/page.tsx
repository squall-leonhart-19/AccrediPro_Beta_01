...
// ─── Main ──────────────────────────────────────────────────────────
function MiniDiplomaCoachResultsInner() {
  ...
  const persona = sp.get("persona") || "health-coach";
        ...
        <Section>
          ...
          <SectionInner className="text-center space-y-5 sm:space-y-6">
            ...
            <p className="text-sm sm:text-base text-gray-600 max-w-xl mx-auto leading-relaxed">
              The exact starting point our highest-earning certified coaches used before going full-time. Level 0 of your functional medicine journey begins here.
            </p>
        ...
        <Section>
          <SectionInner className="space-y-4">
            <h2 className="text-xl sm:text-2xl font-bold text-center" style={{ color: B.burgundyDark }}>
              Coaches Who Upgraded With This
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-[10px] sm:text-[11px] text-gray-400">Coach turned Clinical Practitioner</p>
                </div>
                <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
                  {firstName}, as a coach who made this exact transition myself, I know what you&apos;re going through. The exhaustion. The frustration. The feeling that there must be something more.
                </p>
...
export default function MiniDiplomaCoachResultsPage() {
  return (
    <Suspense fallback={
