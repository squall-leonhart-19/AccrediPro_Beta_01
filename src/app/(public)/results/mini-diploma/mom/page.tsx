...
// ─── Main ──────────────────────────────────────────────────────────
function MiniDiplomaMomResultsInner() {
  ...
  const persona = sp.get("persona") || "stay-at-home-mom";
        ...
        <Section>
          ...
          <SectionInner className="text-center space-y-5 sm:space-y-6">
            ...
            <p className="text-sm sm:text-base text-gray-600 max-w-xl mx-auto leading-relaxed">
              The exact starting point our highest-earning mom practitioners used before going full-time. Level 0 of your functional medicine journey begins here.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="text-[10px] sm:text-[11px] text-gray-400">Mom of 2, Now FM Practitioner</p>
                </div>
                <p className="text-xs sm:text-sm text-gray-700 leading-relaxed">
                  {firstName}, as a mom who built this from my kitchen table myself, I know what you&apos;re going through. The exhaustion. The frustration. The feeling that there must be something more.
                </p>
...
export default function MiniDiplomaMomResultsPage() {
  return (
    <Suspense fallback={
