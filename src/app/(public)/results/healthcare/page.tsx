...
const CERT_IMG = "/certificate-preview.png";
        ...
        <Section bg={`${B.gold}08`}>
          ...
          <SectionInner className="space-y-3">
            {[
              ...
              { title: "Private Practitioner Community", desc: "Lifetime access to our private community of certified practitioners. Get peer support, share case studies, celebrate wins, and network with women on the same path.", value: "$997/yr", icon: Users },
