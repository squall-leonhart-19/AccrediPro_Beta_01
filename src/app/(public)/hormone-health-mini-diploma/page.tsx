...
const TESTIMONIALS = [
    {
        name: "Jennifer M.",
        role: "Former HR Manager → Certified Hormone Health Coach",
    ...
    {
        name: "Rachel T.",
        role: "Yoga Instructor + Hormone Health Specialist",
...
const LEARNING_OUTCOMES = [
    "Identify hormonal imbalances that drive fatigue, weight gain, and mood issues",
    "Understand the thyroid-adrenal-sex hormone connection",
    "Recognize perimenopause and menopause patterns before they become chronic",
    "Design hormone-supportive protocols for women at every life stage",
    "Position yourself as a specialist women desperately need",
];

// What you get - value table
const WHAT_YOU_GET = [
    { item: "3 Expert-Led Modules", value: "Deep-dive into female hormone optimization" },
...
export default function WomensHealthMiniDiplomaPage() {
    ...
    return (
        <div className="min-h-screen bg-white">
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="text-white">
                            ...
                            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight">
                                ...
                                <span className="block text-gold-400 mt-1">Hormone Health Specialist</span>
                            </h1>
                ...
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <div className="bg-white rounded-xl p-5 border border-burgundy-200 max-w-2xl mx-auto">
                        <p className="text-gray-700 italic mb-3">
                            &ldquo;I finished the mini-diploma on my lunch break. Now I&apos;m helping women finally understand their hormones instead of just 'suffering through it.'&rdquo;
                        </p>
                        <p className="text-sm text-gray-500">— Michelle R., Former Nurse, Now Hormone Health Coach</p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-10 bg-gradient-to-r from-burgundy-600 to-burgundy-700">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-burgundy-100 mb-5">
                        We&apos;re currently accepting new students into the Hormone Health track.<br />
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div className="text-center md:text-left">
                                ...
                                <p className="text-gray-600 mb-4 text-sm">
                                    Sarah has helped over 5,000 women optimize their hormones — and build careers doing the same.
                                    After years of struggling with hormonal chaos, she mastered the science of balance.
                                    Now she trains the next generation of Hormone Health specialists.
                                </p>
            ...
            <section className="py-14 bg-gradient-to-br from-burgundy-700 via-burgundy-800 to-burgundy-900">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-burgundy-200 text-lg mb-6 max-w-2xl mx-auto">
                        In 60 minutes, you&apos;ll understand female hormones better than most conventionally trained doctors.
                    </p>
            ...
            {/* Live Chat Widget */}
            <FloatingChatWidget page="hormone-health-mini-diploma" />
        </div>
    );
}
