...
const TESTIMONIALS = [
    {
        name: "Jennifer M.",
        role: "Former HR Manager → Certified Gut Health Coach",
    ...
    {
        name: "Rachel T.",
        role: "Yoga Instructor + Gut Health Specialist",
...
const LEARNING_OUTCOMES = [
    "Identify the root causes of digestive issues most doctors overlook",
    "Understand the gut-brain axis and its impact on mood and energy",
    "Recognize signs of leaky gut, SIBO, and dysbiosis",
    "Design healing protocols for common gut conditions",
    "Position yourself as a specialist in the booming gut health market",
];

// What you get - value table
const WHAT_YOU_GET = [
    { item: "3 Expert-Led Modules", value: "Deep-dive into gut health & microbiome" },
...
export default function WomensHealthMiniDiplomaPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (result?.error) {
                ...
                window.location.href = "/gut-health-mini-diploma/thank-you";
            } else {
                window.location.href = "/gut-health-mini-diploma/thank-you";
            }
    ...
    return (
        <div className="min-h-screen bg-white">
                    ...
                    <div className="grid lg:grid-cols-2 gap-10 items-center">
                        ...
                        <div className="text-white">
                            ...
                            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight">
                                ...
                                <span className="block text-gold-400 mt-1">Gut Health Specialist</span>
                            </h1>
                ...
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <div className="bg-white rounded-xl p-5 border border-burgundy-200 max-w-2xl mx-auto">
                        <p className="text-gray-700 italic mb-3">
                            &ldquo;I finished the mini-diploma on my lunch break. Now I&apos;m helping clients finally understand their digestive issues and heal from the inside out.&rdquo;
                        </p>
                        <p className="text-sm text-gray-500">— Michelle R., Former Nurse, Now Gut Health Specialist</p>
                    </div>
                </div>
            </section>
            ...
            <section className="py-10 bg-gradient-to-r from-burgundy-600 to-burgundy-700">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-burgundy-100 mb-5">
                        We&apos;re currently accepting new students into the Gut Health track.<br />
                        Spots fill fast — over 200 practitioners joined this week alone.
                    </p>
                    <Button
                        onClick={scrollToForm}
                        size="lg"
                        ...
                        <div className="flex flex-col md:flex-row items-center gap-6">
                            ...
                            <div className="text-center md:text-left">
                                ...
                                <p className="text-gray-600 mb-4 text-sm">
                                    Sarah has helped over 5,000 practitioners master gut health — and build thriving practices.
                                    After healing her own chronic digestive issues, she became obsessed with the microbiome.
                                    Now she trains the next generation of Gut Health specialists.
                                </p>
            ...
            <section className="py-14 bg-gradient-to-br from-burgundy-700 via-burgundy-800 to-burgundy-900">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    ...
                    <p className="text-burgundy-200 text-lg mb-6 max-w-2xl mx-auto">
                        In 60 minutes, you&apos;ll understand the gut-health connection better than most conventionally trained doctors.
                    </p>
            ...
            {/* Live Chat Widget */}
            <FloatingChatWidget page="gut-health-mini-diploma" />
        </div>
    );
}
