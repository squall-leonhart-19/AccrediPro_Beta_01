...
export default function ASIHomePage() {
  const stats = [
  ...
  const howItWorks = [
    {
      ...
      icon: Target,
      image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=400&h=300&fit=crop", // Woman at laptop thinking
    },
    {
      step: "2",
      ...
      icon: BookOpen,
      image: "https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=400&h=300&fit=crop", // Studying with laptop
    },
    {
      step: "3",
      ...
      icon: CheckCircle,
      image: "https://images.unsplash.com/photo-1606326608606-aa0b62935f2b?w=400&h=300&fit=crop", // Woman celebrating
    },
    {
      step: "4",
      ...
      icon: Award,
      image: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=400&h=300&fit=crop", // Professional woman
    },
  ];
                  ...
                  <ul className="space-y-2 mb-6">
                    {category.certifications.map((cert, j) => (
                      <li key={j} className="flex items-center gap-2 text-sm text-gray-500">
                        <ChevronRight className="w-4 h-4" style={{ color: BRAND.gold }} />
                        {cert}
                      </li>
                    ))}
                  </ul>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
            {mediaFeatures.map((media, i) => (
              <div key={i} className="text-gray-400 font-bold text-xl md:text-2xl tracking-tight hover:text-gray-600 transition-colors cursor-pointer">
                {media.name}
              </div>
            ))}
          </div>
