        ...
        if (trigger === "daily_standup") {
            ...
            return NextResponse.json({
                ...
                response: {
                    ...
                    senderAvatar: "https://pub-bc3849663dc849e59aee2d3c517f51e1.r2.dev/fm-certification/Sarah-M.webp",
                    senderType: "coach",
                    content: response,
...
Keep it very short (1-2 sentences max).`;
        ...
        if (isCoachResponse || resourceMatch) {
            ...
            responderAvatar = "https://pub-bc3849663dc849e59aee2d3c517f51e1.r2.dev/fm-certification/Sarah-M.webp";
        } else {
