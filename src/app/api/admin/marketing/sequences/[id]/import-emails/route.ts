...
Sarah`,
    ...
    // DEFAULT: Uses shared NURTURE_EMAILS from @/lib/nurture-emails
    // This is populated at runtime below
};

// Add the imported NURTURE_EMAILS as the _default template
// This ensures the same content is used by both import routes
EMAIL_TEMPLATES["_default"] = NURTURE_EMAILS;
