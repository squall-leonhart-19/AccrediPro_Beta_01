...
Sarah`,
  ...
  // ============================================
  // BUYER NURTURING EMAILS - Story + Trust + Upsell
  // 17 emails: Story, Proof, Pain Seed, DFY Launch, Milestone
  // ============================================
  ...
  // === STORY SEQUENCE (Day 1-10) ===
  {
    ...
    originalSubject: "can I share something personal?",
...
Sarah 💕`,
  },
  {
    ...
    day: 3,
    section: "buyer_nurturing",
    originalSubject: "the night everything changed",
...
Sarah`,
  },
  {
    ...
    day: 5,
    section: "buyer_nurturing",
    originalSubject: "she texted me crying",
...
That's the moment I knew this was my life's work.

You're going to have a Rebecca too. Someone who just needs ONE person to see them, believe them, and actually know what to do.
...
Sarah`,
  },
  {
    ...
    day: 7,
    section: "buyer_nurturing",
    originalSubject: "my daughter noticed first",
...
Your journey isn't just about you.
...
Sarah 💕`,
  },
  {
    ...
    day: 10,
    section: "buyer_nurturing",
    originalSubject: "this is why I do this",
...
I'm not special. I'm not smarter or braver than anyone else. I'm just someone who made a decision and kept going.

You're doing the same thing right now.

Thank you for being part of this community. Thank you for trusting this process.
...
P.S. How's the course going? Hit reply and let me know — I read every single response myself. 💕`,
  ...
  // === PROOF SEQUENCE (Day 12-21) ===
  {
    ...
    day: 12,
    section: "buyer_nurturing",
    originalSubject: "40 years nursing... and then this",
...
She found us and enrolled in her certification — not really believing anything would come of it.
...
Diane works 25 hours a week now. From home. Wearing yoga pants.

She's 63 years old. She started from zero. And she did it.

If you've ever thought "I'm too old" or "it's too late for me"...
...
Sarah`,
  },
  {
    ...
    day: 15,
    section: "buyer_nurturing",
    originalSubject: "from kitchen floor to $12k/month",
...
Maria isn't a marketing genius. She doesn't have a fancy website.
...
Sarah`,
  },
  {
    ...
    day: 18,
    section: "buyer_nurturing",
    originalSubject: "'I have no medical background'",
...
Whatever story is in your head about why you "can't" do this...
...
Sarah`,
  },
  {
    ...
    day: 21,
    section: "buyer_nurturing",
    originalSubject: "what they ALL had in common",
...
One lesson at a time. One day at a time.
...
P.S. How are you doing with the course? Reply and let me know — I'm here for you. 💕`,
  ...
  // === PAIN SEED SEQUENCE (Day 24-28) ===
  {
    ...
    day: 24,
    section: "buyer_nurturing",
    originalSubject: "honest question for you",
    subject: "Re: honest question for you",
    content: `{{firstName}},
...
Week 1 after certification: "I need a website first." Spend hours researching. Get overwhelmed.

Week 2: "Maybe I'll just focus on intake forms." Download 12 templates from Pinterest. None fit.

Week 3: "I should probably have contracts and legal documents..." Google templates. Get scared by legal jargon.

Week 4: "I'll just focus on social media..." Stare at blank screen. Post nothing.
...
I have something I'm working on that might help. More soon.
...
Sarah`,
  },
  {
    ...
    day: 26,
    section: "buyer_nurturing",
    originalSubject: "two types of coaches",
...
Type 2 isn't "taking shortcuts" — they're being strategic.
...
Sarah`,
  },
  {
    ...
    day: 28,
    section: "buyer_nurturing",
    originalSubject: "a thought I had about you",
...
I'm opening something special in 2 days.

Only a handful of spots. Everything I described above, built for you.
...
Sarah`,
  ...
  // === DFY LAUNCH SEQUENCE (Day 30-35) ===
  {
    ...
    day: 30,
    section: "buyer_nurturing",
    originalSubject: "opening 10 spots tomorrow",
...
Sarah`,
  },
  {
    ...
    day: 31,
    section: "buyer_nurturing",
    originalSubject: "your spot is ready",
...
Claim your spot here: https://learn.accredipro.academy/dfy-kit
...
"Before this, I spent $8,000 trying to get my business set up. Hired 3 different freelancers. Wasted 4 months. If I'd had this kit from the beginning, I would have saved $7,600 and a year of my life."

You're going to launch your practice eventually.

The question is: Do you want to do it the hard way or the easy way?

Hard way: 4-6 months figuring it out. $3,000-10,000 in random freelancers.

Easy way: $397. Everything done. Launch in 48 hours.

Claim one of the remaining spots: https://learn.accredipro.academy/dfy-kit

7 left as of this morning.
...
Sarah`,
  },
  {
    ...
    day: 35,
    section: "buyer_nurturing",
    originalSubject: "closing tonight",
...
After that, I don't know when we'll open spots again.
...
Last chance: https://learn.accredipro.academy/dfy-kit

Whatever you decide, I support you. But I didn't want you to miss this.

With love,

Sarah

P.S. After tonight, this page disappears. Don't be the person who comes back wishing they'd clicked yes today.`,
  },
  ...
  // === MILESTONE UPSELLS (Pro Accelerator) ===
  {
    ...
    day: 0,
    section: "buyer_nurturing",
    originalSubject: "you've proven you're serious",
...
- Advanced Clinical Track — handle complex cases
- Master Practitioner Track — become THE expert
- Practice & Income Path — get clients and scale
- 3 additional certifications included

Basic certification makes you capable of helping people.

Pro Accelerator makes you the practitioner who handles the $2,500-5,000 cases. The one with a waitlist.

Normal price: $1,997

For you, right now: $297 (one-time)

This offer is only available to students who've hit 50%+ progress.
...
P.S. Michelle (49) was THIS close to skipping this. Now she's at $18,000/month handling complex cases she would have referred out before.`,
  },
  {
    ...
    day: 0,
    section: "buyer_nurturing",
    originalSubject: "what's next for you?",
...
P.S. Karen (55, RN) went from $72K/year nursing to $180K/year coaching after Pro Accelerator.`,
  },
];
