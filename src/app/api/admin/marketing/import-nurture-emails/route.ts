...
Sarah`,
    ...
    {
        order: 6,
        subject: "Re: Kelly's transformation (no health background)",
        delayDays: 11,
        delayHours: 0,
        content: `{{firstName}},
...
Sarah`,
    ...
    {
        order: 7,
        subject: "Re: the fear nobody talks about",
        delayDays: 13,
        delayHours: 0,
        content: `{{firstName}},
...
P.S. When Maria told her mom she was quitting her job for functional medicine, her mom said she was "throwing money away." Now her mom tells everyone about her "successful daughter."`,
    ...
    {
        order: 8,
        subject: "Re: Vicki's side-income story",
        delayDays: 15,
        delayHours: 0,
        content: `{{firstName}},
...
Sarah`,
    ...
    {
        order: 9,
        subject: "Re: what certification actually gets you",
        delayDays: 17,
        delayHours: 0,
        content: `{{firstName}},
...
Sarah`,
    ...
    {
        order: 11,
        subject: "Re: the question you're asking",
        delayDays: 21,
        delayHours: 0,
        content: `{{firstName}},
