...
import PostDetailVariant2 from "@/components/community/variants/post-detail-variant-2";

export default async function Variant2Page() {
    ...
    // Mock Post Data (Same as V1)
    const mockPost = {
        id: "official-graduation-thread",
        title: "Officially Certified? Share Your Graduation News Here!", // Removed emoji for cleaner editorial look
