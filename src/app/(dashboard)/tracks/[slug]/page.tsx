    ...
    "functional-medicine": {
        ...
        steps: [
            ...
            },
            {
                ...
                requiresStep1: true,
                stepLabel: "STEP 2",
                title: "PRO ACCELERATOR UPGRADE",
                subtitle: "The Completeness Upgrade",
                name: "Pro Accelerator Upgrade",
                tagline: "Unlocks Advanced + Master Content",
                slug: "pro-accelerator",
                price: "$397",
                priceValue: 397,
                accessNote: "Self-Paced · Lifetime Access",
                badge: "ACCELERATOR",
                // Question this step answers
                questionItAnswers: "Am I ready for complex cases?",
                // What this step represents
                represents: "I have the advanced knowledge to handle any patient case with confidence.",
                // Core professional training (3 buckets)
                coreTraining: [
                    "Advanced protocols for Lyme, Mold, and Autoimmune",
                    "Master-level clinical case management",
                    "Complete 'Practice in a Box' systems",
                ],
                // Course structure
                structure: {
                    modules: 20,
                    lessons: "100+",
                    includes: "Advanced + Master Tracks",
                },
                // Ethical frame
                ethicalFrame: {
            ...
            },
            {
                ...
                status: "launching",
                stepLabel: "STEP 3",
                title: "10-CLIENT GUARANTEE",
                subtitle: "The Safety Net",
                name: "10-Client Guarantee Mentorship",
                tagline: "We work until you succeed",
                slug: "10-client-guarantee",
                price: "$497",
                priceValue: 497,
                accessNote: "Mentorship + Guarantee",
                badge: "GUARANTEE",
                // Question this step answers
                questionItAnswers: "What if I fail to get clients?",
                // What this step represents
                represents: "I have a mentor ensuring I get my first 10 paying clients.",
                // Core professional training (3 buckets)
                coreTraining: [
                    "Direct mentorship until you reach 10 clients",
                    "Weekly strategy and accountability calls",
                    "Risk-free income guarantee",
                ],
                // Course structure
                structure: {
                    modules: "Mentorship",
                    ...
                    advanced: "Client Getting",
                    master: "Retention",
                    taughtBy: "Sarah Mitchell & Team",
                },
                // Strategic note
            ...
            },
            {
                ...
                name: "Functional Medicine Business Empire",
