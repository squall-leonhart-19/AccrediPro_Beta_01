...
import { LessonPageV2 } from "@/components/courses/learn-v2/lesson-page-v2";
...
export default async function LearnV2Page({
  params,
}: {
    ...
    <LessonPageV2
      ...
      navigation={{
        ...
        nextLesson: nextLesson
          ? { id: nextLesson.id, title: nextLesson.title, moduleId: nextLesson.moduleId }
          : null,
