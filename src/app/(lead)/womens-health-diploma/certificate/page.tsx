...
export default async function CertificatePage() {
    ...
    const certificateId = `WH-${session.user.id.slice(0, 8).toUpperCase()}`;
    ...
    return (
        <div className="min-h-screen bg-gray-100 p-4 md:p-8">
            <div className="max-w-3xl mx-auto">
                {/* Back Button */}
                <Link href="/womens-health-diploma/complete" className="inline-flex items-center text-gray-600 hover:text-burgundy-600 mb-6">
