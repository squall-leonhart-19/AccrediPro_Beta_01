/**
 * Functional Medicine - Dense Sarah DM Nurture Content v3.0 (10/10)
 * 
...
export const FUNCTIONAL_MEDICINE_DMS: SarahDM[] = [
...
I'm Sarah, your guide through the Functional Medicine Mini Diploma. I'll be here every step of the way.
...
export const WH_DM_SCHEDULE = FUNCTIONAL_MEDICINE_DMS.map(dm => ({
    day: dm.day!,
    triggerId: dm.id,
})).sort((a, b) => a.day - b.day);

export function getDMContent(id: string): SarahDM | undefined {
    return [...FUNCTIONAL_MEDICINE_DMS, ...LESSON_COMPLETION_DMS, ...BEHAVIORAL_DMS].find(dm => dm.id === id);
}
