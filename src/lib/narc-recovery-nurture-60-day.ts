/**
 * Narcissistic Abuse Recovery Mini Diploma - 60-Day Nurture Sequence v3.0
 * 
...
export const NARC_RECOVERY_NURTURE_SEQUENCE = [
    // ============================================
    ...
    // Email 1 - Day 0: Welcome
    {
        ...
        phase: "value",
        day: 0,
        subject: "Re: your Narcissistic Abuse Recovery access, {{firstName}}",
...
Your Narcissistic Abuse Recovery Mini Diploma is ready. This isn't like other free courses - this is real training from the same institute that certifies Board Certified Master Practitioners.
...
It's been a week since you started your Narcissistic Abuse Recovery Mini Diploma, and I'm curious:
...
It's been two weeks since you started your Narcissistic Abuse Recovery journey with AccrediPro Standards Institute.
...
export type WHNurtureEmailV3 = typeof NARC_RECOVERY_NURTURE_SEQUENCE[number];
