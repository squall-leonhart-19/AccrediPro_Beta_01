/**
 * Gut Health Mini Diploma - 60-Day Nurture Sequence v3.0
 * 
...
export const GUT_HEALTH_NURTURE_SEQUENCE = [
    // ============================================
    ...
    // Email 1 - Day 0: Welcome
    {
        ...
        phase: "value",
        day: 0,
        subject: "Re: your Gut Health access, {{firstName}}",
...
Your Gut Health Mini Diploma is ready. This isn't like other free courses - this is real training from the same institute that certifies Board Certified Master Practitioners.
...
So tell me, {{firstName}} - what made you curious about gut health? What's your story?
...
It's been a week since you started your Gut Health Mini Diploma, and I'm curious:
...
It's been two weeks since you started your Gut Health journey with AccrediPro Standards Institute.
...
If you've finished: I'm SO proud of you. You now understand more about gut health than most people ever will. Your completion certificate is on its way.
...
After: "Diane Smith, RN, GH-BC - Board Certified Master Practitioner"
...
9:00am - First client call. A woman in Texas with hormone symptoms. I sign my notes: "Sarah, GH-BC"
...
I introduce myself differently now: "I'm Sarah, a Board Certified Master Practitioner specializing in gut health."
...
You're Board Certified. Three levels complete: GH-FC, GH-CP, GH-BC.

You introduce yourself: "Hi, I'm {{firstName}}, GH-BC - Board Certified Master Practitioner."
...
- GH-FC (Foundation Certified)
- GH-CP (Certified Practitioner)
- GH-BC (Board Certified Master)
...
LEVEL 1: GH-FC - Foundation Certified
- Core principles
- Basic assessment skills
- Your first credential

LEVEL 2: GH-CP - Certified Practitioner
- Clinical depth
- Protocol design
- Advanced techniques

LEVEL 3: GH-BC - Board Certified Master
- Elite status
- Complex cases
- Full authority
...
AFTER Certification:
"{{firstName}}, GH-BC - Board Certified Master Practitioner"
...
THE DIRECTORY:
Women searching for "certified gut health practitioner" find YOU.
...
Maria told me: "The day I updated my LinkedIn to show GH-BC was the day everything clicked. I wasn't 'trying to be' a practitioner. I WAS one."

You're not buying a course for $297.

You're becoming {{firstName}}, GH-BC - Board Certified Master Practitioner.
...
1. A woman in Dallas searches "certified gut health practitioner near me"

2. ASI Directory ranks high (we invest heavily in SEO)

3. She finds GH-BC practitioners in her area
...
Certification: You become {{firstName}}, GH-BC.
...
Whenever you're ready to become {{firstName}}, GH-BC - you know where to find me.
...
export type WHNurtureEmailV3 = typeof GUT_HEALTH_NURTURE_SEQUENCE[number];
