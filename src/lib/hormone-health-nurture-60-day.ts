/**
 * Hormone Health Mini Diploma - 60-Day Nurture Sequence v3.0
 * 
...
export const HORMONE_HEALTH_NURTURE_SEQUENCE = [
    // ============================================
    ...
    // Email 1 - Day 0: Welcome
    {
        ...
        phase: "value",
        day: 0,
        subject: "Re: your Hormone Health access, {{firstName}}",
...
Your Hormone Health Mini Diploma is ready. This isn't like other free courses - this is real training from the same institute that certifies Board Certified Master Practitioners.
...
So tell me, {{firstName}} - what made you curious about hormone health? What's your story?
...
It's been a week since you started your Hormone Health Mini Diploma, and I'm curious:
...
It's been two weeks since you started your Hormone Health journey with AccrediPro Standards Institute.
...
If you've finished: I'm SO proud of you. You now understand more about hormone health than most people ever will. Your completion certificate is on its way.
...
After: "Diane Smith, RN, HH-BC - Board Certified Master Practitioner"
...
9:00am - First client call. A woman in Texas with hormone symptoms. I sign my notes: "Sarah, HH-BC"
...
I introduce myself differently now: "I'm Sarah, a Board Certified Master Practitioner specializing in hormone health."
...
You're Board Certified. Three levels complete: HH-FC, HH-CP, HH-BC.

You introduce yourself: "Hi, I'm {{firstName}}, HH-BC - Board Certified Master Practitioner."
...
- HH-FC (Foundation Certified)
- HH-CP (Certified Practitioner)
- HH-BC (Board Certified Master)
...
LEVEL 1: HH-FC - Foundation Certified
- Core principles
- Basic assessment skills
- Your first credential

LEVEL 2: HH-CP - Certified Practitioner
- Clinical depth
- Protocol design
- Advanced techniques

LEVEL 3: HH-BC - Board Certified Master
- Elite status
- Complex cases
- Full authority
...
AFTER Certification:
"{{firstName}}, HH-BC - Board Certified Master Practitioner"
...
THE DIRECTORY:
Women searching for "certified hormone health practitioner" find YOU.
...
Maria told me: "The day I updated my LinkedIn to show HH-BC was the day everything clicked. I wasn't 'trying to be' a practitioner. I WAS one."

You're not buying a course for $297.

You're becoming {{firstName}}, HH-BC - Board Certified Master Practitioner.
...
1. A woman in Dallas searches "certified hormone health practitioner near me"

2. ASI Directory ranks high (we invest heavily in SEO)

3. She finds HH-BC practitioners in her area
...
Certification: You become {{firstName}}, HH-BC.
...
Whenever you're ready to become {{firstName}}, HH-BC - you know where to find me.
...
export type WHNurtureEmailV3 = typeof HORMONE_HEALTH_NURTURE_SEQUENCE[number];
