/**
 * Narcissistic Abuse Recovery - Dense Sarah DM Nurture Content v3.0 (10/10)
 * 
...
export const NARC_RECOVERY_DMS: SarahDM[] = [
...
I'm Sarah, your guide through the Narcissistic Abuse Recovery Mini Diploma. I'll be here every step of the way.
...
export const WH_DM_SCHEDULE = NARC_RECOVERY_DMS.map(dm => ({
    day: dm.day!,
    triggerId: dm.id,
})).sort((a, b) => a.day - b.day);

export function getDMContent(id: string): SarahDM | undefined {
    return [...NARC_RECOVERY_DMS, ...LESSON_COMPLETION_DMS, ...BEHAVIORAL_DMS].find(dm => dm.id === id);
}
