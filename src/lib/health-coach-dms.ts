/**
 * Certified Health Coach - Dense Sarah DM Nurture Content v3.0 (10/10)
 * 
...
export const HEALTH_COACH_DMS: SarahDM[] = [
...
I'm Sarah, your guide through the Certified Health Coach Mini Diploma. I'll be here every step of the way.
...
One year from now: You're Board Certified. HC-FC, HC-CP, HC-BC.

Clients find you through the ASI Directory.

Your Mastermind pod texts you every morning.

You introduce yourself: "I'm {{firstName}}, HC-BC - Board Certified Master Practitioner."
...
"The day I updated my LinkedIn to show HC-BC was the day everything clicked. I wasn't 'trying to be' a practitioner. I WAS one."
- Maria
...
1. Woman in Dallas searches "certified health coaching practitioner"
...
Everything you need:
→ 3 certifications (HC-FC, HC-CP, HC-BC)
...
After certification:
You SAY: "I'm {{firstName}}, HC-BC - Board Certified Master Practitioner"
...
Ready to become {{firstName}}, HC-BC?
...
A friend, sister, colleague who's curious about health coaching?
...
You now understand the 5 key hormones that run health coaching.
...
When you're ready to become {{firstName}}, HC-BC - Board Certified Master Practitioner:
...
export const WH_DM_SCHEDULE = HEALTH_COACH_DMS.map(dm => ({
    day: dm.day!,
    triggerId: dm.id,
})).sort((a, b) => a.day - b.day);

export function getDMContent(id: string): SarahDM | undefined {
    return [...HEALTH_COACH_DMS, ...LESSON_COMPLETION_DMS, ...BEHAVIORAL_DMS].find(dm => dm.id === id);
}
