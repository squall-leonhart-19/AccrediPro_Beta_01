/**
 * Hormone Health - Dense Sarah DM Nurture Content v3.0 (10/10)
 * 
...
export const HORMONE_HEALTH_DMS: SarahDM[] = [
...
I'm Sarah, your guide through the Hormone Health Mini Diploma. I'll be here every step of the way.
...
One year from now: You're Board Certified. HH-FC, HH-CP, HH-BC.

Clients find you through the ASI Directory.

Your Mastermind pod texts you every morning.

You introduce yourself: "I'm {{firstName}}, HH-BC - Board Certified Master Practitioner."
...
"The day I updated my LinkedIn to show HH-BC was the day everything clicked. I wasn't 'trying to be' a practitioner. I WAS one."
- Maria
...
1. Woman in Dallas searches "certified hormone health practitioner"
...
Everything you need:
→ 3 certifications (HH-FC, HH-CP, HH-BC)
...
After certification:
You SAY: "I'm {{firstName}}, HH-BC - Board Certified Master Practitioner"
...
Ready to become {{firstName}}, HH-BC?
...
A friend, sister, colleague who's curious about hormone health?
...
You now understand the 5 key hormones that run hormone health.
...
When you're ready to become {{firstName}}, HH-BC - Board Certified Master Practitioner:
...
export const WH_DM_SCHEDULE = HORMONE_HEALTH_DMS.map(dm => ({
    day: dm.day!,
    triggerId: dm.id,
})).sort((a, b) => a.day - b.day);

export function getDMContent(id: string): SarahDM | undefined {
    return [...HORMONE_HEALTH_DMS, ...LESSON_COMPLETION_DMS, ...BEHAVIORAL_DMS].find(dm => dm.id === id);
}
