/**
 * Certified Health Coach Mini Diploma - 60-Day Nurture Sequence v3.0
 * 
...
export const HEALTH_COACH_NURTURE_SEQUENCE = [
    // ============================================
    ...
    // Email 1 - Day 0: Welcome
    {
        ...
        phase: "value",
        day: 0,
        subject: "Re: your Certified Health Coach access, {{firstName}}",
...
Your Certified Health Coach Mini Diploma is ready. This isn't like other free courses - this is real training from the same institute that certifies Board Certified Master Practitioners.
...
So tell me, {{firstName}} - what made you curious about health coaching? What's your story?
...
It's been a week since you started your Certified Health Coach Mini Diploma, and I'm curious:
...
It's been two weeks since you started your Certified Health Coach journey with AccrediPro Standards Institute.
...
If you've finished: I'm SO proud of you. You now understand more about health coaching than most people ever will. Your completion certificate is on its way.
...
After: "Diane Smith, RN, HC-BC - Board Certified Master Practitioner"
...
9:00am - First client call. A woman in Texas with hormone symptoms. I sign my notes: "Sarah, HC-BC"
...
I introduce myself differently now: "I'm Sarah, a Board Certified Master Practitioner specializing in health coaching."
...
You're Board Certified. Three levels complete: HC-FC, HC-CP, HC-BC.

You introduce yourself: "Hi, I'm {{firstName}}, HC-BC - Board Certified Master Practitioner."
...
- HC-FC (Foundation Certified)
- HC-CP (Certified Practitioner)
- HC-BC (Board Certified Master)
...
LEVEL 1: HC-FC - Foundation Certified
- Core principles
- Basic assessment skills
- Your first credential

LEVEL 2: HC-CP - Certified Practitioner
- Clinical depth
- Protocol design
- Advanced techniques

LEVEL 3: HC-BC - Board Certified Master
- Elite status
- Complex cases
- Full authority
...
AFTER Certification:
"{{firstName}}, HC-BC - Board Certified Master Practitioner"
...
THE DIRECTORY:
Women searching for "certified health coaching practitioner" find YOU.
...
Maria told me: "The day I updated my LinkedIn to show HC-BC was the day everything clicked. I wasn't 'trying to be' a practitioner. I WAS one."

You're not buying a course for $297.

You're becoming {{firstName}}, HC-BC - Board Certified Master Practitioner.
...
1. A woman in Dallas searches "certified health coaching practitioner near me"

2. ASI Directory ranks high (we invest heavily in SEO)

3. She finds HC-BC practitioners in her area
...
Certification: You become {{firstName}}, HC-BC.
...
Whenever you're ready to become {{firstName}}, HC-BC - you know where to find me.
...
export type WHNurtureEmailV3 = typeof HEALTH_COACH_NURTURE_SEQUENCE[number];
