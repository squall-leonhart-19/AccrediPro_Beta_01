/**
 * Functional Medicine Mini Diploma - 60-Day Nurture Sequence v3.0
 * 
...
export const FUNCTIONAL_MEDICINE_NURTURE_SEQUENCE = [
    // ============================================
...
1. "I had no idea about the 5 root causes of chronic disease" (most women only know two!)
...
It's been two weeks since you started your Functional Medicine journey with AccrediPro Standards Institute.
...
If you've finished: I'm SO proud of you. You now understand more about functional medicine than most people ever will. Your completion certificate is on its way.
...
You're Board Certified. Three levels complete: FM-FC, FM-CP, FM-BC.
...
LEVEL 1: FM-FC - Foundation Certified
- Core principles
- Basic assessment skills
- Your first credential

LEVEL 2: FM-CP - Certified Practitioner
- Clinical depth
- Protocol design
- Advanced techniques

LEVEL 3: FM-BC - Board Certified Master
- Elite status
- Complex cases
- Full authority
...
1. A woman in Dallas searches "certified functional medicine practitioner near me"

2. ASI Directory ranks high (we invest heavily in SEO)

3. She finds FM-BC practitioners in her area
...
Certification: You become {{firstName}}, FM-BC.
...
export type WHNurtureEmailV3 = typeof FUNCTIONAL_MEDICINE_NURTURE_SEQUENCE[number];
