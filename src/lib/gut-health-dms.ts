/**
 * Gut Health - Dense Sarah DM Nurture Content v3.0 (10/10)
 * 
...
export const GUT_HEALTH_DMS: SarahDM[] = [
...
I'm Sarah, your guide through the Gut Health Mini Diploma. I'll be here every step of the way.
...
One year from now: You're Board Certified. GH-FC, GH-CP, GH-BC.

Clients find you through the ASI Directory.

Your Mastermind pod texts you every morning.

You introduce yourself: "I'm {{firstName}}, GH-BC - Board Certified Master Practitioner."
...
"The day I updated my LinkedIn to show GH-BC was the day everything clicked. I wasn't 'trying to be' a practitioner. I WAS one."
- Maria
...
1. Woman in Dallas searches "certified gut health practitioner"
...
Everything you need:
→ 3 certifications (GH-FC, GH-CP, GH-BC)
...
After certification:
You SAY: "I'm {{firstName}}, GH-BC - Board Certified Master Practitioner"
...
Ready to become {{firstName}}, GH-BC?
...
A friend, sister, colleague who's curious about gut health?
...
You now understand the 5 key hormones that run gut health.
...
When you're ready to become {{firstName}}, GH-BC - Board Certified Master Practitioner:
...
export const WH_DM_SCHEDULE = GUT_HEALTH_DMS.map(dm => ({
    day: dm.day!,
    triggerId: dm.id,
})).sort((a, b) => a.day - b.day);

export function getDMContent(id: string): SarahDM | undefined {
    return [...GUT_HEALTH_DMS, ...LESSON_COMPLETION_DMS, ...BEHAVIORAL_DMS].find(dm => dm.id === id);
}
